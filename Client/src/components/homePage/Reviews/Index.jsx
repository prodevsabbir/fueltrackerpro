...
import { AlertCircle, ThumbsUp, User, ShieldCheck, MessageSquare, Loader2 } from 'lucide-react';
          ...
          >
            <div className="p-5">
              ...
              <div className="mt-2 flex items-center gap-1.5">
                 ...
                 <span className="text-[9px] font-black text-amber-600 uppercase tracking-widest">{report.stationId?.name || 'Unknown'}</span>
              </div>
            </div>
            
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
              <button className="flex items-center gap-1.5 text-[10px] font-black text-slate-400 hover:text-amber-500 transition-colors uppercase tracking-widest">
              ...
              <div className="flex items-center gap-1">
                 ...
                 <span className="text-[9px] font-black text-emerald-600">100% {t.reports.trust}</span>
              </div>
            </div>
          </motion.div>
        )) : (
